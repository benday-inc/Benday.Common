...
public class CheckThatForIListsFixture : TestClassBase
{
    

    public CheckThatForIListsFixture(ITestOutputHelper output) : base(output)
    {
    ...
    public void CheckThat_IsEqualTo_True()
    {
        ...
        IList<ClassForTesting> input = new List<ClassForTesting> { a, b, c };
        IList<ClassForTesting> expected = new List<ClassForTesting> { a, b, c };
    ...
    public void CheckThat_IsEqualTo_False()
    {
        ...
        var c = new ClassForTesting();
        IList<ClassForTesting> input = new List<ClassForTesting> { a, b, c };
        IList<ClassForTesting> expected = new List<ClassForTesting> { c, b, a };
        var check = input.CheckThatCollection();
    ...
    public void CheckThat_IsNotEqualTo_True()
    {
        ...
        var c = new ClassForTesting();
        IList<ClassForTesting> input = new List<ClassForTesting> { a, b, c };
        IList<ClassForTesting> notExpected = new List<ClassForTesting> { c, b, a };
        var check = input.CheckThatCollection();
    ...
    public void CheckThat_IsNotEqualTo_False()
    {
        ...
        var c = new ClassForTesting();
        IList<ClassForTesting> input = new List<ClassForTesting> { a, b, c };
        IList<ClassForTesting> notExpected = new List<ClassForTesting> { a, b, c };
    ...
    public void CheckThat_IsEquivalentTo_True()
    {
        ...
        var c = new ClassForTesting();
        IList<ClassForTesting> input = new List<ClassForTesting> { a, b, c };
        IList<ClassForTesting> expected = new List<ClassForTesting> { c, a, b };
        var check = input.CheckThatCollection(); 
    ...
    public void CheckThat_IsEquivalentTo_False()
    {
        ...
        IList<ClassForTesting> input = new List<ClassForTesting> { a, b, c };
        IList<ClassForTesting> expected = new List<ClassForTesting> { a, b, d };
        var check = input.CheckThatCollection();
        Assert.Throws<CheckAssertionFailureException>(() =>
            check.IsEquivalentTo(expected)
        );
    ...
    public void CheckThat_IsNotEquivalentTo_True()
    {
        ...
        IList<ClassForTesting> input = new List<ClassForTesting> { a, b, c };
        IList<ClassForTesting> notExpected = new List<ClassForTesting> { x, y, z };
        var check = input.CheckThatCollection();
    ...
    public void CheckThat_AllItemsAreUnique_False()
    {
        var a = new ClassForTesting();
        var b = new ClassForTesting();
        IList<ClassForTesting> input = new List<ClassForTesting> { a, b, a };
        var check = input.CheckThatCollection();
        Assert.Throws<CheckAssertionFailureException>(() =>
             check.AllItemsAreUnique()
        );
    ...
    public void CheckThat_IsSubsetOf_True()
    {
        ...
        var c = new ClassForTesting();
        var d = new ClassForTesting();
        IList<ClassForTesting> input = new List<ClassForTesting> { a, b };
        IList<ClassForTesting> superset = new List<ClassForTesting> { a, b, c, d };
        var check = input.CheckThatCollection(); 
    ...
    public void CheckThat_IsSubsetOf_False()
    {
        ...
        IList<ClassForTesting> input = new List<ClassForTesting> { a, b, e };
        IList<ClassForTesting> superset = new List<ClassForTesting> { a, b, c, d };
        var check = input.CheckThatCollection();
        Assert.Throws<CheckAssertionFailureException>(() =>
             check.IsSubsetOf(superset)
    ...
    public void CheckThat_IsSupersetOf_True()
    {
        ...
        var c = new ClassForTesting();
        var d = new ClassForTesting();
        IList<ClassForTesting> input = new List<ClassForTesting> { a, b, c, d };
        IList<ClassForTesting> subset = new List<ClassForTesting> { b, c };
        var check = input.CheckThatCollection(); 
    ...
    public void CheckThat_IsSupersetOf_False()
    {
        ...
        var d = new ClassForTesting();
        IList<ClassForTesting> input = new List<ClassForTesting> { a, b, c };
        IList<ClassForTesting> subset = new List<ClassForTesting> { b, d };
        var check = input.CheckThatCollection();
        Assert.Throws<CheckAssertionFailureException>(() =>
            check.IsSupersetOf(subset)
        );
